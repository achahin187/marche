                        ...
                        <ul class="cart_items_list">
                            ...
                            <li class="cart_item item_list d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-end justify-content-start">
                                <div class="product d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start mr-auto">
                                    ...
                                    <div><div class="product_image"><img src="uploades/{{ $item->model->image }}" alt=""></div></div>
                                    <div class="product_name_container">
                                        <div class="product_name"><a href="{{ route('product.show',$item->model->id) }}">{{ $item->model->name }}</a></div>
                                        <div class="product_text">{{ $item->model->desc }}</div>
                                    </div>
                                </div>
                                <div class="product_color product_text"><span>Color: </span>beige</div>
                                <div class="product_size product_text"><span>Size: </span>L</div>
                                <div class="product_price product_text"><span>Price: </span>${{ $item->model->price }}</div>
                                ...
                                <div class="product_total product_text"><span>Total: </span>${{ $item->total() }}</div>
                    ...
                    <div class="cart_extra_content cart_extra_total">
                        ...
                        <ul class="cart_extra_total_list">
                            ...
                            <li class="d-flex flex-row align-items-center justify-content-start">
                                ...
                                <div class="cart_extra_total_value ml-auto">${{Cart::tax()}}</div>
                            </li>
                            <li class="d-flex flex-row align-items-center justify-content-start">
                                <div class="cart_extra_total_title">Total</div>
                                <div class="cart_extra_total_value ml-auto">${{Cart::total()}}</div>
                            </li>
                        </ul>
                        <div class="checkout_button trans_200"><a href="{{ route('checkOut.index') }}">proceed to checkout</a></div>
                    </div>
                </div>
            </div>
        </div>
