    ...
    <div class="home">
        <div class="home_container d-flex flex-column align-items-center justify-content-end">
            <div class="home_content text-center">
                <div class="home_title"> Chat With  {{ $friendInfo->name}}  </div>
    ...
    <div class="product">
        ...
        <div class="col-md-9 chat-section">
            <div class="chat-header">
                ...
                <div class="chat-name font-weight-bold">
                    {{ $friendInfo->name }}
                    <i class="fa fa-circle user-status-head user-icon-{{ $friendInfo->id }}" title="away"></i>
                </div>
            </div>
...
<script>
    $(function (){
        ...
        function appendMessageToSender(message) {
            ...
            let userInfo ='<div class="col-md-12 user-info">\n'+'<div class="chat-image">\n'+ image +'</div>\n'+'\n'+'<div class="chat-name font-weight-bold">\n'+ name +'<span class="small time text-gray-500" title="'+moment().format(message.created_at)+'">\n'+moment().fromNow()+'</span>\n'+'</div>\n' +'</div>\n';
        ...
        function appendMessageToReceiver(message) {
            ...
            let userInfo = '<div class="col-md-12 user-info">\n'+'<div class="chat-image">\n'+ image +'</div>\n'+'\n'+'<div class="chat-name font-weight-bold">\n'+ name+'<span class="small time text-gray-500" title="'+moment().format(message.created_at)+'">\n'+moment().format(message.created_at)+'</span>\n'+'</div>\n'+'</div>\n';
            let messageContent = '<div class="col-md-12 message-content">\n'+'<div class="message-text">\n'+message.content+'</div>\n'+'</div>';
            let newMessage = '<div class="row message align-items-center mb-2">'+userInfo+messageContent+'</div>';
            $messageWrapper.append(newMessage);
        }
